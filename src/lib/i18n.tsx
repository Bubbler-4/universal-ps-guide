...
const translations = {
  en: {
    ...
    search: "Search",
    searchSuggestionView: "View",
    searchSuggestionAdd: "Add",
    searchSuggestionCreate: "Create",
    searchSuggestionNoMatch: "No matching problems.",
    searchSuggestionCreateDesc: "Create a problem for this ID",
  ...
  ko: {
    ...
    search: "검색",
    searchSuggestionView: "보기",
    searchSuggestionAdd: "추가",
    searchSuggestionCreate: "생성",
    searchSuggestionNoMatch: "일치하는 문제가 없습니다.",
    searchSuggestionCreateDesc: "이 ID로 문제 생성",
