      ...
      <Show when={data()?.status === "ok"}>
        <Show
          ...
          fallback={
            <div class="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-xl p-8 text-center">
              <h1 class="text-2xl font-bold text-green-700 dark:text-green-300 mb-2">{t("translationSubmitted")}</h1>
        ...
        >
          ...
          <div class="flex flex-col gap-6">
            {/* Editor */}
            <div>
              <label for="translation-content" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
